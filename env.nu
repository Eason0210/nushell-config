...
if $nu.os-info.name == "macos" {
   ...
   $env.PATH = ($env.PATH | append "/Applications/Emacs.app/Contents/MacOS")
   $env.PATH = ($env.PATH | append "/Applications/Emacs.app/Contents/MacOS/bin")
   $env.PATH = ($env.PATH | append "/Library/TeX/texbin")
}

$env.ALTERNATE_EDITOR = 'emacs -nw -q'
